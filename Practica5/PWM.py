...
class PWM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._offset_range = Range(-5, 5, 100e-3, -1, 200)
        ...
        self._ampS_range = Range(0, 7, 100e-3, 2, 200)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 10000, ampS, offset, 0)
    ...
    def set_offset(self, offset):
        self.offset = offset
        self.analog_sig_source_x_1.set_offset(self.offset)
    ...
    def set_ampS(self, ampS):
        self.ampS = ampS
        self.analog_sig_source_x_1.set_amplitude(self.ampS)
