...
class PAM_MUX(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "PAM_MUX", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PAM_MUX")
        ...
        self.settings = Qt.QSettings("GNU Radio", "PAM_MUX")
        ...
        self.analog_sig_source_x_0_2 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 100, 1, 0, 0)
        ...
        self.connect((self.ModuladorPAM_0_0, 0), (self.blocks_delay_0_1, 0))
        ...
        self.connect((self.analog_sig_source_x_0_0, 0), (self.ModuladorPAM_0_1, 0))
        self.connect((self.analog_sig_source_x_0_1, 0), (self.ModuladorPAM_0_2, 0))
...
def main(top_block_cls=PAM_MUX, options=None):
